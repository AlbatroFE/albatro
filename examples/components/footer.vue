...
" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
        <a href="https://github.com/AlbatroFE/albatro
/releases" class="footer-main-link" target="_blank">{{ langConfig.changelog }}</a>
        <a href="https://github.com/AlbatroFE/albatro
...
/starter" class="footer-main-link" target="_blank">{{ langConfig.starter }}</a>
      ...
      <div class="footer-main">
        ...
        <a href="https://github.com/AlbatroFE/albatro
/issues" class="footer-main-link" target="_blank">{{ langConfig.feedback }}</a>
        <a :href="`https://github.com/AlbatroFE/albatro
/blob/master/.github/CONTRIBUTING.${ lang }.md`" class="footer-main-link" target="_blank">{{ langConfig.contribution }}</a>
      ...
      <div class="footer-social">
        ...
        <a href="https://github.com/AlbatroFE" target="_blank">
