        ...
        <li>
          <div class="card">
            ...
            <a
              ...
              href="https://github.com/AlbatroFE/albatro/Resources/raw/master/AlbatroUI_Components_v2.0.0.rplib"
            ><%= 5 ></a>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <a 
              ...
              href="https://github.com/AlbatroFE/albatro/Resources/raw/master/AlbatroUI%20UI%20Kit_v2.0.sketch"
            ><%= 5 ></a>
          </div>
        </li>
        <!--<li>-->
          <!--<div class="card">-->
            ...
            <!--<h3><%= 8 ></h3>-->
            <!--<p><%= 9 ></p>-->
            <!--<a href="https://github.com/AlbatroFE/albatro/Resources/raw/master/AlbatroUI%20Components%20Documentation.zip"><%= 5 ></a>-->
          <!--</div>-->
        <!--</li>-->
      </ul>
    </div>
